"""add relationship_to_child enum types and set email to be nullable=True

Revision ID: ffb6c0839ff2
Revises: ba551533e51d
Create Date: 2023-10-17 00:54:55.570567
...
new_options = sorted(old_options + ('ADOPTIVE_PARENT', 'FOSTER_PARENT', 'BIOLOGICAL_PARENT', 'STEP_PARENT', 'MATERNAL_GRANDPARENT',
'PATERNAL_GRANDPARENT', 'SIBLING', 'STEP_SIBLING', 'HALF_SIBLING', 'UNCLE/AUNT', 'OTHER_RELATIVE', 'OTHER'))
...
def upgrade():
    ...
    op.execute('ALTER TABLE caregivers ALTER COLUMN relationship_to_child TYPE ' + enum_name + ' USING relationship_to_child::text::' + enum_name)
    # Drop old enum type
