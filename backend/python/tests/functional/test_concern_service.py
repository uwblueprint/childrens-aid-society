...
DEFAULT_CONCERNS = (
    ...
    {"concern": "ISOLATION", "type": "FAMILIAL_CONCERN", "show_by_default": False},
    {
        "concern": "WEAPONS_IN_HOME",
        "type": "FAMILIAL_CONCERN",
        "show_by_default": False,
    },
    {"concern": "CHILD_ABUSE", "type": "FAMILIAL_CONCERN", "show_by_default": False},
    {"concern": "CHILD_NEGLECT", "type": "FAMILIAL_CONCERN", "show_by_default": False},
    {"concern": "SEXUAL_ABUSE", "type": "FAMILIAL_CONCERN", "show_by_default": False},
    {
    ...
    {"concern": "MENTAL_HEALTH", "type": "FAMILIAL_CONCERN", "show_by_default": False},
    {
    ...
    {"concern": "POVERTY", "type": "FAMILIAL_CONCERN", "show_by_default": False},
    {
    ...
    {"concern": "MENTAL_HEALTH", "type": "CHILD_BEHAVIOUR", "show_by_default": False},
    {"concern": "RUNAWAY", "type": "CHILD_BEHAVIOUR", "show_by_default": False},
    {"concern": "CHILD_BEHAVIORS", "type": "CHILD_BEHAVIOUR", "show_by_default": False},
    {"concern": "SEXUAL_ABUSE", "type": "CHILD_BEHAVIOUR", "show_by_default": False},
    {
        "concern": "DEVELOPMENTAL_DISABILITY",
        "type": "CHILD_BEHAVIOUR",
        "show_by_default": False,
    },
    {"concern": "SUBSTANCE_ABUSE", "type": "CHILD_BEHAVIOUR", "show_by_default": False},
    {
